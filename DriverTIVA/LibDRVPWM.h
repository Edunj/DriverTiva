...
extern void ForWardMotor(uint8_t pot, char Bridge);
extern void ReverseMotor(uint8_t pot, char Bridge);
extern void brakeMotor(char Bridge);


#endif /* __DRIVERTIVA_LIBDRVPWM_H_ */
